...
function PharmacyOSMark() {
  return (
    <svg viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <rect x="37" y="43" width="12" height="42" rx="6" fill="#06100d" />
      <rect x="58" y="35" width="12" height="58" rx="6" fill="#06100d" />
      <rect x="79" y="43" width="12" height="42" rx="6" fill="#06100d" />
    </svg>
  );
}
...
export function BrandSplash({
  ...
  return (
    <div className={classes} role="status" aria-live="polite" aria-label={t('loading_aria')}>
      ...
      <div className="bs-stage">
        ...
        <div className="bs-icon">
          {logoSrc ? (
            <img src={logoSrc} alt={title || t('logo_alt')} />
          ) : (
            <PharmacyOSMark />
          )}
        </div>
