...
export default function LoginPage() {
  ...
  useEffect(() => {
    // Valid session? Redirect to the dashboard immediately — with or without ?next=
    if (!authLoading && user) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -end-40 w-80 h-80 bg-primary/10 rounded-full blur-3xl animate-float" />
        <div className="absolute -bottom-40 -start-40 w-80 h-80 bg-primary/5 rounded-full blur-3xl animate-float" style={{ animationDelay: "1s" }} />
      ...
      <div className="relative w-full max-w-md mx-4 animate-scale-in">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="mb-4 inline-flex items-center justify-center" aria-label={t("home_aria")}>
            <img
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  dir="ltr"
                  className="flex h-10 w-full rounded-lg border border-input bg-background ps-12 pe-10 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 transition-all duration-200"
                />
                <button
                  type="button"
