...
import { ArrowRight, Barcode, CreditCard, Database, FileSpreadsheet, Languages, ReceiptText } from 'lucide-react'
 ...
 */
const SECTIONS = [
  { key: 'subscription', href: '/settings/subscription', icon: CreditCard },
