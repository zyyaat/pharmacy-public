...
// misconfiguration shows up directly in the hosting provider logs:
//
...
//   - a subdomain wildcard: *.vercel.app (matches any subdomain at any depth,
//     e.g. pharmacy-app.vercel.app and project-git-fix.vercel.app, but NOT
//     vercel.app itself and NOT evil-vercel-app.com)
//   - "*"                   allow everything (prefer explicit origins in production)
