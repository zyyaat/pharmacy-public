...
class ApiClient {
  ...
  Future<PaymentStatusInfo> paymentStatus(String paymentId) async {
    final body =
        await _send('GET', '/pharmacy/subscription/payments/$paymentId');
    return PaymentStatusInfo.fromJson(mOf(body['data']));
  }
